...
function approve(address spender, uint value) virtual override external returns (bool) {
...
function transferFrom(address from, address to, uint value) virtual override external returns (bool) {
...
function permit(address owner, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) virtual override external {
...
function mint(address to) virtual external lock returns (uint liquidity) {
...
// this low-level function should be called from a contract which performs important safety checks
function burn(address to) virtual external lock returns (uint amount0, uint amount1) {
(uint112 _reserve0, uint112 _reserve1,) = getReserves(); // gas savings
...
// this low-level function should be called from a contract which performs important safety checks
function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) virtual external lock {
...
function skim(address to) virtual external lock {
address _token0 = token0; // gas savings
address _token1 = token1; // gas savings
...
function sync() virtual external lock {
